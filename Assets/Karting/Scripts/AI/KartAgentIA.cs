...
namespace KartGame.AI
{
    ...
    /// </summary>
    public class KartAgentIA : Agent, IInput
    {
        /// <summary>
        ...
        void FixedUpdate()
        {
            ...
            var step = 4.0f * Time.deltaTime; // calculate distance to move
            kart.transform.position = Vector3.MoveTowards(kart.transform.position, nextCollider.transform.position, step);
            //navMeshAgent.SetDestination(nextCollider.transform.position);
